...
assessSpatialGraphCoherenceOverall <- function(feature_graph, feature_matrix_for_similarity, spatial_coords_df, k_neighbors = 10, modality_name = "Modality") {
  ...
  for (i in 1:num_cells) {
    ...
    if (length(spatial_nn_indices) > 0) {
      ...
      # Metric 4: Graph Distance to Spatial Neighbors (using feature_graph similarity)
      graph_sim_to_spatial_nn_from_graph <- feature_graph[current_cell_id, cell_ids[spatial_nn_indices]]
      
      graph_dist_to_spatial_nn <- 1 - graph_sim_to_spatial_nn_from_graph
